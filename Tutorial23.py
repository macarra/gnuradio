...
class Tutorial2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Tutorial 2 Part 3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Tutorial 2 Part 3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Tutorial2")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(10000, analog.GR_COS_WAVE, 2000, 1, 0, 0)
        ...
        self.Tab2.addTab(self.Tab2_widget_0, 'Time')
        ...
        self.Tab2.addTab(self.Tab2_widget_1, 'Frequency')
...
def main(top_block_cls=Tutorial2, options=None):
