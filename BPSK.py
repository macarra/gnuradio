...
class BPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "BPSK Modulator")
        ...
        self.digital_scrambler_bb_0 = digital.scrambler_bb(0xc1, 0x7F, 7)
        ...
        self.connect((self.blocks_null_source_0, 0), (self.digital_scrambler_bb_0, 0))
        ...
        self.connect((self.digital_scrambler_bb_0, 0), (self.digital_psk_mod_0, 0))
